...
class Scratch3Speech2TextBlocks {
    constructor(runtime) {
        ...
        this._onTranscriptionFromServer = this._onTranscriptionFromServer.bind(
            this
        );
            ...
            target.blocks._scripts.forEach((id) => {
                ...
                if (b.opcode === "speech_whenIHearHat") {
                    ...
                    if (inputBlock.opcode === "text") {
                        const word = target.blocks.getBlock(inputId).fields.TEXT
                            .value;
                        words.push(word);
                    }
                }
    ...
    _shouldKeepResult(fuzzyMatchIndex, result, normalizedTranscript) {
        ...
        const shouldKeepPhraseListMatch = this._phraseList.includes(
