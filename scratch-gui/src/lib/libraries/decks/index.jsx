...
export default {
    ...
    "soumitya-youtube-video2": {
        name: (
            <FormattedMessage
                defaultMessage="soumitya youtube video2"
                description="Name for the 'soumitya-youtube-video2' how-to"
                id="gui.howtos.soumitya-youtube-video2.name"
                title="youtubeViedoEmbed"
                videoLinks={[
                    "https://www.youtube.com/embed/tgbNymZ7vqY",
                    "https://www.youtube.com/embed/cLuUP-hl0YI",
                    "https://www.youtube.com/embed/P-bamOO-MzY",
                ]}
            />
        ),
        img: libraryMakeMusic,
            ...
            },
            {
                title: (
                    <FormattedMessage
                        defaultMessage="Pick an Instrument Sprite "
                        description="Step name for 'Pick an Instrument Sprite' step"
                        id="gui.howtos.soumitya-youtube-video2.step_PickInstrument"
                    />
                ),
                image: "musicPickInstrument",
            },
