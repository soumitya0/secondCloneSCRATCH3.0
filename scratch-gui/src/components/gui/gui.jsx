            ...
            {(isFullSize) => {
                ...
                return isPlayerOnly ? (
                    ...
                    >
                        ...
                        {/* ★ TWO SECTION OF GUI LEFT AND RIGHT (BLOCK ONE - ANAMITION ONE)  ★ */}
                        {/* LEFT SECTION HAVE MENU AND BLOCK PART */}
                        {/* RIGHT SECTION HAVR ANAMATION SECTIONS */}
                        <Box className={styles.bodyWrapper}>
                            <Box className={styles.flexWrapper}>
                                <Box className={styles.editorWrapper}>
                                    {/* MENU -> CODE, COUSTUMEES, SOUND */}
                                    <Tabs
                                        forceRenderTabPanel
                                    ...
                                    {/* ★ REMOVE BACKPACK BAR AT THE BOTTOM SCREEN★ */}
                                    {/* {backpackVisible ? (
                                ...
                                >
                                    {/* ★ RIGHT SIDE OF anamition SCREEN ★ */}
                                    <StageWrapper
                                        isFullScreen={isFullScreen}
                                        isRendererSupported={
                                            isRendererSupported
