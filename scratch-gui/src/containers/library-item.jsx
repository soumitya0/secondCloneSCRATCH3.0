...
class LibraryItem extends React.PureComponent {
    ...
    handleClick(e) {
        console.log(e.target, "handleClick");
    ...
    render() {
        ...
        // console.log(this.props.name.defaultMessage, "DefaultMessage-Tutorial");

        console.log(iconMd5, "iconMd5");
        console.log(this.props, "PROPS");

        console.log(iconURL, "ICONE URL");
        console.log(this.props.iconRawURL, "iconRawURL");
        console.log(this.props.name, "this.props.name 20.");
        return (
